...
var AnimationFrame = require("../../../../util/wxdraw.js").AnimationFrame;
...
Page({
  ...
  onLoad: function () {
    ...
    */
    ...
    setTimeout(() => {
      this.wxCanvas.reset();
      let img3 = new Shape('image', { x: 50, y: 30, w: 100, h: 100, file: "./1.png" }, 'fill', true);
      this.wxCanvas.add(img3);
      img3.animate({x: '+=100'}, {duration: 1000}).start(1);
    }, 2000);
    //   { rotate:-Math.PI/4}
    // );
